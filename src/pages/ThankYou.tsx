  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-muted to-background">
      <div className="container max-w-4xl mx-auto px-4 py-12 md:py-20">
        ...
        <Card className="p-8 mb-8 shadow-xl animate-in fade-in slide-in-from-bottom duration-700 delay-300">
          ...
          <Button variant="cta" size="lg" className="w-full mb-6" onClick={() => window.open('https://pt.z-lib.fm/', '_blank')}>
        ...
        <Card className="p-8 mb-8 bg-gradient-to-br from-accent/10 to-primary/10 border-2 border-accent/30 shadow-xl animate-in fade-in slide-in-from-bottom duration-700 delay-500">
          ...
          <p className="text-lg mb-4 text-foreground">
            Acervo Privado <strong>      "Milhares de E-books no Google Drive"</strong>
          </p>
          <p className="text-muted-foreground mb-6">Tudo Organizado e disponível para download.
          </p>

          <Button variant="secondary" size="lg" className="w-full" onClick={() => window.open('https://drive.google.com/drive/folders/1rEkxrjnCVaRxOyoYPZ6cXKKOOQFdg8iD?usp=sharing', '_blank')}>
        ...
        <Card className="p-8 mb-8 shadow-xl animate-in fade-in slide-in-from-bottom duration-700 delay-700">
          ...
          <Button variant="default" size="lg" className="w-full" onClick={() => window.open('https://readera.org/', '_blank')}>
        ...
        <Card className="p-8 text-center bg-card/50 backdrop-blur-sm shadow-lg animate-in fade-in slide-in-from-bottom duration-700 delay-700">
          ...
          <div className="bg-muted/50 rounded-lg p-4 inline-block">
            ...
            <a href="mailto:professoraana.cultura@gmail.com" className="text-primary hover:underline font-medium">
